...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EmTxLHeiCnjIcvkjqZu2.mE8I339tJFhxtCF3vU8AmG.WQydqzfWuWiD+bbrP4c8VZQD5QrIHAIzUkc06e6WMjs=")
cl.loginResult()
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Terimakasih Telah Menambahkan Saya Sebagai Teman Anda Bot Ini Bisa Auto Like TimeLine",
    "lang":"JP",
    "comment":"Terimakasih Telah Menambahkan Saya Sebagai Teman Anda Bot Ini Bisa Auto Like TimeLine",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif "Gram" in msg.text:
              if msg.from_ in Bots:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Gram","")
                    gs = cl.getGroup(msg.to)
